...
if not GEMINI_API_KEY:
    print("ERROR: GEMINI_API_KEY environment variable is not set. Please set it before running the app.")
...
def reset_storage():
    ...
    ensure_base_dirs()
    save_state(default_state("History cleared. Storage reset complete."))
